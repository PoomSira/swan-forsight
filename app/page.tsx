...
import { AlertCircle, Battery, Zap, Thermometer, Gauge, Info } from "lucide-react";
import {
              ...
              <>
                ...
                >
                  ...
                  <motion.div variants={itemVariants}>
                    <UITooltip>
                      <TooltipTrigger>
                        <Card className="overflow-hidden cursor-help hover:shadow-lg transition-shadow">
                      ...
                      <TooltipContent className="max-w-xs">
                        <div className="space-y-2">
                          ...
                          <p className="text-sm">
                            Energy currently being generated from your solar panels. During the day, higher values indicate better sunlight. At night, this should be near zero.
                          </p>
                          <p className="text-xs text-muted-foreground mt-2">
                            <strong>PV1 & PV2:</strong> Your solar panel strings on different sides of your roof. Different voltages are normal.
                          </p>
                        </div>
                      </TooltipContent>
                    </UITooltip>
                  ...
                  <motion.div variants={itemVariants}>
                    <UITooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <div className="space-y-2">
                          <p className="font-semibold">Battery State of Charge (SOC)</p>
                          <p className="text-sm">
                            Percentage of battery remaining. Used to power your home when solar panels aren't generating energy. Low levels (&lt;20%) mean the system may soon switch to grid power.
                          </p>
                          <p className="text-xs text-muted-foreground mt-2">
                            <strong>Health (SoH):</strong> Long-term battery condition. High values (90%+) indicate excellent battery health with minimal wear.
                          </p>
                        </div>
                      </TooltipContent>
                    </UITooltip>
                    ...
                    <UITooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <div className="space-y-2">
                          ...
                          <p className="text-sm">
                            Total electricity your home is consuming right now. This includes lights, appliances, HVAC, refrigerators, and all devices running simultaneously.
                          </p>
                          <p className="text-xs text-muted-foreground mt-2">
                            Lower values at night indicate minimal power usage. Compare this with battery discharge rate to estimate battery runtime.
                          </p>
                        </div>
                      </TooltipContent>
                    </UITooltip>
                  ...
                  <motion.div variants={itemVariants}>
                    <UITooltip>
                        ...
                        <Card className="overflow-hidden cursor-help hover:shadow-lg transition-shadow">
                          ...
                          <CardContent>
                            <motion.div
                              ...
                              animate="animate"
                            >
                              {(latest.inverter_temperature_c || 0).toFixed(1)}°C
                            </motion.div>
                            <p className="text-xs text-muted-foreground">
                      ...
                      <TooltipContent className="max-w-xs">
                        <div className="space-y-2">
                          <p className="font-semibold">Inverter Temperature & Grid Frequency</p>
                          <p className="text-sm">
                            <strong>Temperature:</strong> Operating temperature of your inverter. Normal range is 20-40°C. Above 50-60°C may indicate thermal stress. The inverter is the "brain" converting DC solar power to AC home power.
                          </p>
                          <p className="text-sm">
                            <strong>Grid Frequency:</strong> 50 Hz (Australia/Europe) or 60 Hz (North America). Standard "heartbeat" of the electricity grid. Indicates system synchronization.
                          </p>
                        </div>
                      </TooltipContent>
                    </UITooltip>
                  ...
                  <motion.div variants={itemVariants} className="lg:col-span-2">
                    <Card className="overflow-hidden">
                      <CardHeader>
                        ...
                        <CardDescription>Real-time energy generation and consumption</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <ResponsiveContainer width="100%" height={300}>
                          <LineChart data={chartData}>
                            ...
                            <XAxis dataKey="time" />
                            <YAxis />
                            <Tooltip formatter={(value) => `${value.toLocaleString()}W`} />
                            <Legend />
                            <Line
                              type="monotone"
                              dataKey="pv"
                ...
                <motion.div variants={itemVariants}>
                  <Card className="overflow-hidden">
                    <CardHeader>
                      ...
                      <CardDescription>Individual panel power generation</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <motion.div variants={itemVariants}>
                  <Card className="overflow-hidden">
                    <CardHeader>
                      ...
                      <CardDescription>Last 10 energy readings from your FoxESS inverter</CardDescription>
                    </CardHeader>
                    <CardContent>
                          ...
                          <tbody>
                            {readings.slice(0, 10).map((reading, idx) => (
                              ...
                              >
                                ...
                                <td className="text-right py-2 px-2">
                                  {(reading.inverter_temperature_c || 0).toFixed(1)}°C
                                </td>
                              </motion.tr>
                            ))}
                          </tbody>
